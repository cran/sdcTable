...
- **"SIMPLEHEURISTIC"**: solving the problem using a fast heuristic approach that aims to only protect against exact recalculation of values
...
used while ``r getInfo(resSIMPLE, 'nrSecondSupps')`` additional suppressions were required for the fast heuristic simple procedure *"SIMPLEHEURISTIC"*.
